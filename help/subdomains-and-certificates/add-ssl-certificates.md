...
* [Página inicial da Experience Cloud](https://experience.adobe.com/#/home) > Seletor de soluções: **[!DNL Campaign]** > Cartão **[!UICONTROL Painel de Controle]** > Cartão **[!UICONTROL Subdomínios e Certificados]**
...
>* Depois que uma CSR é gerada, você pode baixá-la novamente nos logs do trabalho. Esse recurso não se aplica a certificados gerados antes desta versão.
>
