...
description: Saiba como se conectar ao servidor SFTP usando um aplicativo SFTP cliente com as chaves que você armazenou no Painel de controle do Campaign.
...
# Conectar-se a um servidor SFTP
